...
describe('instantiate client', () => {
  ...
  test('explicit global fetch', async () => {
    ...
    const client = new Riza({ baseURL: 'http://localhost:5000/', apiKey: 'My API Key', fetch: defaultFetch });
  });
  ...
  test('normalized method', async () => {
    ...
    const client = new Riza({ baseURL: 'http://localhost:5000/', apiKey: 'My API Key', fetch: testFetch });
  ...
  describe('baseUrl', () => {
    ...
    test('in request options overridden by client options', () => {
      const client = new Riza({ apiKey: 'My API Key', baseURL: 'http://localhost:5000/client' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
    ...
    test('in request options overridden by env variable', () => {
      process.env['RIZA_BASE_URL'] = 'http://localhost:5000/env';
      const client = new Riza({ apiKey: 'My API Key' });
      expect(client.buildURL('/foo', null, 'http://localhost:5000/option')).toEqual(
...
describe('retries', () => {
  ...
  test('retry count header', async () => {
    ...
    const client = new Riza({ apiKey: 'My API Key', fetch: testFetch, maxRetries: 4 });
